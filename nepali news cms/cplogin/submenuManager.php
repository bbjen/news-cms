<?php
	if(isset($_GET['m']) && intval($_GET['m'])!=0)
		...
		if($mvo->id == 0)
			echo "<script>window.location='index.php?p=menu&msg=Main menu was not found';</script>";
		}
	else
		echo "<script>window.location='index.php?p=menu&msg=Main menu was not found';</script>";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="24%" class="medium" colspan="2" align="left"><strong><?php $_SESSION['mailtitle']=$mvo->title; echo $mvo->title ." / ".$mvo->title ;?></strong></td>
  </tr>
  <tr>
    <td colspan="2">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" style="border:1px solid #ccc;">
		<tr style="background-color:#ccc;">
			...
			<td width="21%" class="theader3"><strong>Submenu Title (English) </strong></td>
		 	...
		 	<td width="23%" class="theader3"><strong>Content Required</strong></td>
		 	<td width="24%" class="theader3"><strong>Options</strong></td>
		...
		if(!empty($menulist)){
				...
				<tr <?php if($sn%2==0) echo 'bgcolor="#efefef"';?>>
					...
					<td class="tcell2"><a href="index.php?p=submenu1&m=<?php echo $submenu->id;?>"><strong>Sub Menus</strong></a> | <a href="index.php?p=aesubmenu1&m=<?php echo $submenu->id;?>"><strong>Add Sub Menus</strong></a>
                    
                    </td>
					<td class="tcell2">
					<a href="index.php?p=aesubmenu&m=<?php echo $submenu->mainmenu_id;?>&eSid=<?php echo $submenu->id;?>"><img src="./images/edit.gif" border="0" /></a> 
					<a href="index.php?p=submenu&m=<?php echo $submenu->mainmenu_id;?>&rSid=<?php echo $submenu->id;?>" onClick="return confirm('Make sure before you delete this menu?');"><img src="./images/delete.gif" border="0" /></a>					</td>
				</tr>
				<?php
				}
			}
			...
			<tr bgcolor="#efefef">
				...
				<td class="tcell2" colspan="4" align="center"><font color="#cc0000">No Submenu has been inserted for this menu yet.</font></td>
				<td class="tcell2">&nbsp;</td>
			</tr>
			<?
			}
...
<div align="right">
	<a href="index.php?p=menu" class="theader3">&nbsp;&nbsp;<strong>Back</strong>&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;
