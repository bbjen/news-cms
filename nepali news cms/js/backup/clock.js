...
document.write('<PARAM NAME="movie" VALUE="images/clock.swf">');
document.write('<PARAM NAME="quality" VALUE="high">');
document.write('<PARAM NAME="bgcolor" VALUE="#5C5054">');
document.write('<PARAM NAME="wmode" VALUE="transparent">');
document.write('<PARAM NAME="menu" VALUE="false">');

document.write('<EMBED SRC="images/clock.swf" WIDTH="'+clocksize+'" HEIGHT="'+clocksize+'" QUALITY="high" WMODE="transparent" MENU="false"></EMBED>');
