  ...
  <div id='lefter_scrollj'><a href='javascript:slide("left");'><img src='images/left.png' /></a></div>
    <div id='sab_wrap'>
        ...
        <?php
			...
			$query =mysql_query("SELECT * FROM tbl_leftmenu WHERE lftmenu='Lekh Rachana' AND is_archieve='1' ORDER BY published_date DESC LIMIT 4");
				while($row=mysql_fetch_array($query)){ 
					echo "<li><a href='index.php?jpg=article&jID=".$row['id']."' title='".$row['title']."'><img src=vignette.php?f=images/uploaded/".$row['files']."&w=62&h=95>	</a></li>";
				}			
			?>
