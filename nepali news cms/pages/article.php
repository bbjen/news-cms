...
<?php	//session_start();
	...
	//echo $read;
		...
		$sql="SELECT * FROM tbl_leftmenu WHERE  id='$id' AND is_archieve ='1'";
		$result=mysql_query($sql);
		   echo "<div class=mainText id=demoText>";	
          			while($row=mysql_fetch_array($result)){						  	
						echo "<h1>". $row['title']."</h1><br>";
						echo "<div class=floatTxt>".$row['name']."<br><br>".stripslashes($row['short_descs'])."</div>";
...
<!-- .............. ralated news .......... -->
	...
	<div class="wrapper">
		<div class="heading_news">
        	<p class="heading_news_1">Latest 10 Articles<br/></p>
            ...
            ?>
                <p class="left_txt_1">
                	<?php echo "<a href='index.php?jpg=article&jID=".$newsletter->id."' title='".$newsletter->title."'>".ucfirst($newsletter->title)."</a>"; ?>                       
                </p>
			<?php
					}
				}
