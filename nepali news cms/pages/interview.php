...
<?php
	$id=$_GET['jID'];
	$page = $_GET['jpg'];
		$sql="SELECT * FROM tbl_interview WHERE  id='$id' AND is_archieve ='1'";
		$result=mysql_query($sql);
		   echo "<div class=mainText id=demoText>";	
          			while($row=mysql_fetch_array($result)){						  	
						echo "<h1>". $row['subject']."</h1><br>";
						echo "<div class=floatTxt>".$row['name']."<br><br>".stripslashes($row['shortdescription'])."</div>";
						echo "<div class='floatPic'><img src='images/uploaded/".$row['files']."'></div>";
...
<div class="aj" style="height:10px;"></div>
	<div class="wrapper">
		<div class="heading_news">
        	<p class="heading_news_1">Latest 10 Interview<br/></p>
            ...
            ?>
                <p class="left_txt_1">
                	<?php echo "<a href='index.php?jpg=interview&jID=".$newsletter->id."' title='".$newsletter->subject."'>".ucfirst($newsletter->subject)."</a>"; ?>                       
                </p>
			<?php
					}
				}
