...
<div class="wrapper">
	<div class="heading_news">
        <p class="heading_news_1">Latest Interview<br/></p>
        	<?php              
            	$newsletterdao = new InterviewDAO();
				$total=$newsletterdao->countInterview();
				
				$limit = 10; 
				$link = "jpg=interviewHome";
            ...
            ?>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo stripslashes(ucfirst($newsletter->shortdescription))."...<br><a href='index.php?jpg=interview&jID=".$newsletter->id."' title='".$newsletter->subject."'>+ &#2341;&#2346; &#2309;&#2352;&#2369;...</a><br><br>"; ?></p>
